...
_adminLevel1 =
[
	'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)','spectating','adminconsole','Delete Vehicle','FlyUp','EjectTarget','ToggleVehLock','ShowGear','HealSelf','HealRepairNear','AddAmmoSelf','AdminStart','AdminLog','Freeze Target','UnFreeze Target','==== Weapons ====','==== Magazines ====','==== Bags ====','==== Vehicles ====','==== Objects ====','==== Loadouts ====','==== AltisLife Money ====','Remove Gear','Revive','Heal','Repair','Move In My Vehicle','Move In Target Vehicle','Spawn UAV','Spawn Cloak','Spawn Sapper','Spawn SapperB','Eject','Eject Crew','Kill','Explode','Zeus','Force Disconnect','Kick (Silent)','Kick (Announce)','Ban (Silent)','Ban (Announce)','infiSTAR Player ESP','infiSTAR Dead ESP','infiSTAR AI ESP','Epoch Player ESP','Epoch Vehicle ESP','infiSTAR MapIcons','PlotPole Marker','Vehicle Marker','Construction Marker','LockBox Marker','DeadPlayer Marker','God Mode','Vehicle God Mode','Lower Terrain','Vehboost','UnlimAmmo','noRecoil','FastFire','Stealth / Invisible','Disable Announces','Show FPS','Give All Liscenses','Call EMP','Mass Message','DayTime','NightTime','change crypto','Spawn Epoch-Box','Spawn Support-Box1','Spawn Support-Box2','Spawn Support-Box3','Spawn Ammo','showinfo','Login as Arma Admin','FreeRoam Cam (RightClick to exit)'
];
_adminLevel2_UIDs =
[
	'0','0','0'
...
_adminLevel3_UIDs =
[
	'76561198041582893','76561198011826863','76561198036376000','76561198000373935','76561198061912622','76561198051496034','76561198076019631','76561198002823566','76561197970995765','76561198075472326','76561198062939181','76561198011826863'
];
_adminLevel3 =
[
	'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)','spectating','adminconsole','Delete Vehicle','FlyUp','EjectTarget','ToggleVehLock','ShowGear','HealSelf','HealRepairNear','AddAmmoSelf','AdminStart','AdminLog','Freeze Target','UnFreeze Target','==== Weapons ====','==== Magazines ====','==== Bags ====','==== Vehicles ====','==== Objects ====','==== Loadouts ====','==== AltisLife Money ====','Remove Gear','Revive','Heal','Repair','Move In My Vehicle','Move In Target Vehicle','Spawn UAV','Spawn Cloak','Spawn Sapper','Spawn SapperB','Eject','Eject Crew','Kill','Explode','Zeus','Force Disconnect','Kick (Silent)','Kick (Announce)','Ban (Silent)','Ban (Announce)','infiSTAR Player ESP','infiSTAR Dead ESP','infiSTAR AI ESP','Epoch Player ESP','Epoch Vehicle ESP','infiSTAR MapIcons','PlotPole Marker','Vehicle Marker','Construction Marker','LockBox Marker','DeadPlayer Marker','God Mode','Vehicle God Mode','Lower Terrain','Vehboost','UnlimAmmo','noRecoil','FastFire','Stealth / Invisible','Disable Announces','Show FPS','Give All Liscenses','Call EMP','Mass Message','DayTime','NightTime','change crypto','Spawn Epoch-Box','Spawn Support-Box1','Spawn Support-Box2','Spawn Support-Box3','Spawn Ammo','showinfo','Login as Arma Admin','FreeRoam Cam (RightClick to exit)'
...
_aLocalM =
[
	'sek_','_marker','marker_','house_','_dead_marker','_gpstracker','cop','Marker200','SEM_','Plane','Bandit','Strange'
];
...
_badDialogsClose =
[
	2,3,7,17,19,25,26,27,28,29,30,31,32,37,40,41,43,44,45,51,52,53,74,85,106,126,127,129,132,146,147,150,151,152,153,154,159,164,262,314,632,1320,2121
];
