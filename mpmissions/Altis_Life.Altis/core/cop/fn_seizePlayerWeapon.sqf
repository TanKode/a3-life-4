...
[[52, player, format["%1 wurde entwaffnet", name cursorTarget]],"TON_fnc_logIt",false,false] spawn life_fnc_MP;rsorTarget]],"TON_fnc_logIt",false,false] spawn life_fnc_MP;